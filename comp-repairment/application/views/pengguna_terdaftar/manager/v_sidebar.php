    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            ...
            <ul class="list">
                ...
                <?php if ($page == 'riwayat_perbaikan' || $page == 'riwayat_kerusakan'): ?>
                  <li class="active">
                <?php else: ?>
                  <li>
                <?php endif; ?>
                        ...
                        <ul class="ml-menu">
                            <?php if ($page == 'riwayat_perbaikan'): ?>
                              <li class="active">
                            <?php else: ?>
                                <li>
                            <?php endif; ?>
                                <a href="<?=base_url('manager/riwayat')?>">Riwayat Perbaikan Perangkat</a>
                                </li>
                            ...
                            <?php else: ?>
                                <li>
                            <?php endif; ?>
                                <a href="<?=base_url('manager/perangkat')?>">Riwayat Kerusakan Perangkat</a>
                            </li>
                        </ul>
                </li>
